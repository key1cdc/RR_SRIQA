...
class Reg_ResidualBlock(nn.Module):
    def __init__(self, in_channels=64):
        ...
        self.conv1 = nn.Conv2d(in_channels=in_channels, out_channels=in_channels, kernel_size=3, stride=1, padding=1, bias=True)
        self.bn1 = nn.BatchNorm2d(in_channels)
        self.relu = nn.ReLU(True)
        self.conv2 = nn.Conv2d(in_channels=in_channels, out_channels=in_channels, kernel_size=3, stride=1, padding=1, bias=True)
...
class H_Reg_256(nn.Module):
    def __init__(self):
        super(H_Reg_256, self).__init__()
